...
const INSTITUTES_INITIAL = [
  ...
  {
    id: '3',
    name: 'Western Coaching Foundation',
    location: 'Denver, CO',
    accreditation: 'Accredited Level II',
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    accreditation: 'Accredited Level IV',
    joined: 'Joined Nov 2020',
    initials: 'TL',
    color: '#1D9E75',
    bg: '#E1F5EE',
    access: ['Student', 'Parent', 'Teacher'],
  ...
  {
    id: '5',
    name: 'Pacific Mentorship Center',
  ...
  {
    id: '6',
    name: 'Atlantic Coaching Guild',
    location: 'Boston, MA',
    accreditation: 'Accredited Level III',
    joined: 'Joined Sep 2019',
    initials: 'AC',
    color: '#3B6D11',
    bg: '#EAF3DE',
      ...
      <ScrollView contentContainerStyle={styles.detailContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailsTable}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={styles.tableValue}>INS-{institute.id}</Text>
          </View>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={[styles.tableRow, styles.tableRowAlt]}>
              ...
              <Text style={styles.tableValue}>Aman</Text>
            </View>

            {/*Admin contact Row*/}
            <View style={[styles.tableRow, styles.tableRowAlt]}>
              <Text style={styles.tableLabel}>📞 Admin Contact</Text>
              <Text style={styles.tableValue}>aman@example.com</Text>
            </View>
...
export default function AddInstitute({ onInstituteClick, selectedInstitute: externalSelectedInstitute }) {
  ...
  const [institutes, setInstitutes] = useState(INSTITUTES_INITIAL);
  ...
  const handleAddInstitute = (newInstitute) => {
    const id = (institutes.length + 1).toString();
    const initials = newInstitute.name
      .split(' ')
      .map(word => word[0])
      .join('')
      .toUpperCase();
    ...
    const instituteData = {
      ...
      accreditation: newInstitute.accreditation || 'Accredited Level III',
      joined: `Joined ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'short' })}`,
      initials,
    ...
    setInstitutes([...institutes, instituteData]);
